...
class GoogleSheetsService:
    ...
    def _get_or_create_worksheet(self, title):
        ...
        try:
            ...
            worksheet.append_row(["Date", "Type", "Description", "Total Amount", "Document Key"])
             ...
             try:
                 ...
                 if not is_new_sheet and len(all_values) >= 1:
                     ...
                     has_wrong_headers = (
                         ...
                         (any('Total Amount' in str(cell) for cell in header_row) and 
                          any('Document Key' in str(cell) for cell in header_row))
                     )
