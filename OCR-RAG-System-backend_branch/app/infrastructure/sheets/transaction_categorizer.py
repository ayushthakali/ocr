...
class TransactionCategorizer:
    ...
    def find_company_match(self, company_name: str, doc_data: Dict) -> Tuple[Optional[str], float, str]:
        """
        ...
        if best_issuer_match >= self.similarity_threshold and best_issuer_match > best_receiver_match:
    ...
    def categorize_transaction(self, doc_data: Dict, company_name: str) -> Dict:
        ...
        role, confidence, matched_name = self.find_company_match(company_name, doc_data)
